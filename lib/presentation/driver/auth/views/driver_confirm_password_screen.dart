...
class DriverConfirmPasswordScreen extends StatefulWidget {
  const DriverConfirmPasswordScreen({super.key});

  @override
  State<DriverConfirmPasswordScreen> createState() =>
      _ConfirmPasswordScreenState();
}

class _ConfirmPasswordScreenState extends State<DriverConfirmPasswordScreen> {
                              ...
                              TextButton(
                                onPressed: () {
                                  ...
                                  Navigator.pushNamedAndRemoveUntil(
                                    context,
                                    AppRoutesName.userloginScreenRoute,
                                    (route) => false,
                                  );
                                },
