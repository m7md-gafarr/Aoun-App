...
class DriverResetPasswordScreen extends StatefulWidget {
  ...
  @override
  State<DriverResetPasswordScreen> createState() => _ResetPasswordScreenState();
}

class _ResetPasswordScreenState extends State<DriverResetPasswordScreen> {
                    ...
                    child: BlocConsumer<SendOtpForPasswordResetCubit,
                      ...
                      listener: (context, state) {
                        if (state is SendOtpForPasswordResetFailure) {
                          ...
                          Navigator.pushNamed(
                            context,
                            AppRoutesName.driverOTPScreenRoute,
