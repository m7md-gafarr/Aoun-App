...
class UserRegisterCubit extends Cubit<UserRegisterState> {
  ...
  UserRegisterCubit(this.connectionCubit) : super(RegisterInitial());

  Future<void> registerUser(
      UserAuthModel user, LocationModel location, BuildContext context) async {
    ...
    try {
      ApiResponse<Map<String, dynamic>> response =
          await AuthenticationRepository()
              .registerUser(user: user, location: location);
