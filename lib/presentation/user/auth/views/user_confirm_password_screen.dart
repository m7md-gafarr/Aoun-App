...
class UserConfirmPasswordScreen extends StatefulWidget {
  const UserConfirmPasswordScreen({super.key});

  @override
  State<UserConfirmPasswordScreen> createState() =>
      _ConfirmPasswordScreenState();
}

class _ConfirmPasswordScreenState extends State<UserConfirmPasswordScreen> {
